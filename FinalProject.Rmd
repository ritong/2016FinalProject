...
**This project is based on real complany data to analyze the relationships of Virtual Machine(VM) remote session usage with date time and geolocation of VM and remote clients. The company name remains anonymous in the project.**
...
#session<-read_csv("/Users/chenr1/Documents/data_science/FinalProject/session.csv")
session <- read_csv(gzfile("/Users/chenr1/Documents/data_science/FinalProject/2016FinalProject/session.csv.gz"))
